...
"""
This script eases the use of Plotly when using tensors (especially in CUDA).

Borrowed from the ARENA materials: https://github.com/callummcdougall/ARENA_3.0/blob/main/chapter1_transformer_interp/exercises/plotly_utils.py
"""
